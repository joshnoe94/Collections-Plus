...
export async function addItem(collectionId, partial) {
  //fixme When modifying items array of subcollection a new array object will be created. The items array of the subcollection in the parent must be changed to the new object
  let out = {};
  await mutate((data) => {
